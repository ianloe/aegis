...
# Install bash so the entrypoint can use /dev/tcp for MySQL readiness checks
...
# Copy the programmatic migration runner (uses drizzle-orm, no drizzle-kit needed)
